...
The screenshots in the handoff? Full of PII. Every single one needs to go through a verification pass: does this screenshot contain real user data, real email addresses, real names, real anything that should not be published on a documentation site?
...
Not a heads-up before the work started. After. While I'm in it.
